<form class="js-search-form form-inline-custom" action="{{route('clients.shareholders.index')}}"
  id="f_search_shareholder" data-container="#js_list_shareholders" novalidate data-action="search"
  data-module="shareholder">
