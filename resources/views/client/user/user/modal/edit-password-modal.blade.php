<div id="js_edit_password_modal" class="modal fade js-edit-password-modal" style="overflow:hidden;" role="dialog"
        ...
        <div class="modal-content">
            <form novalidate data-action="update_password" data-module="user" class="js-update-password-form"
                ...
                <div class="modal-header">
                    <h4 class="modal-title">{{__("Đổi mật khẩu cho tài khoản ")}} <span class="js-username text-danger"></span></h4>
