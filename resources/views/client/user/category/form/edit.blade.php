<form novalidate data-action="store" data-module="category" class="js-update-form"
      action="{{route('clients.categories.update', ['category' => $category->id])}}"
      data-row-id="#{{$category->row_id}}" method="PUT" data-list-url="{{route('clients.categories.index')}}">
    <div class="modal-header">
        <h4 class="modal-title">{{__("Sửa thông tin nhóm hàng hóa")}}</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="code" value="{{ $category->code }}"
                           placeholder="Nhập mã nhóm hàng hóa">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="recommend_amount"
                               value="{{ $category->recommend_amount }}" placeholder="Nhập lãi suất">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="payment_day" value="{{ $category->payment_day}}" placeholder="Kỳ lãi">
                        <div class="input-group-append">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="liquided_day" value="{{ $category->liquided_day}}" placeholder="Thanh lý">
                        <div class="input-group-append">
                            <span class="input-group-text">ngày</span>
                        </div>
                    </div>
