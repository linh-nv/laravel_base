<form class="js-search-form form-inline-custom" action="{{route('clients.invoice-types.index')}}"
  id="f_search_invoice_type" data-container="#js_list_invoice_types" novalidate data-action="search"
  data-module="invoice_type">
