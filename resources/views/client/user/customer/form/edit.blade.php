<form novalidate data-action="store" data-module="customer" class="js-update-form"
    action="{{route('clients.customers.update', ['customer' => $customer->id])}}"
    data-row-id="#{{$customer->row_id}}" method="PUT" data-list-url="{{route('clients.customers.index')}}">
    <div class="modal-header">
        <h4 class="modal-title">{{__("Sửa thông tin khách hàng")}}</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="identify_number" value="{{$customer->identify_number}}" placeholder="Nhập số CMND/CCCD">
