@extends('client.layout.base',['pageTitle'=>'Dashboard'])
@section('content')
                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover m-0 table-actions-bar">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('client/assets/images/users/avatar-2.jpg')}}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('client/assets/images/users/avatar-3.jpg')}}"
                                             alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('client/assets/images/users/avatar-4.jpg')}}"
                                             alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('client/assets/images/users/avatar-5.jpg')}}"
                                             alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('client/assets/images/users/avatar-8.jpg')}}"
                                             alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                    </td>
