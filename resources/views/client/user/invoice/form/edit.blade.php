<form novalidate data-action="store" data-module="invoice" class="js-update-form"
    action="{{route('clients.invoices.update', ['invoice' => $invoice->id])}}"
    data-row-id="#{{$invoice->row_id}}" method="PUT" data-list-url="{{route('clients.invoices.index')}}">
    <div class="modal-header">
        <h4 class="modal-title">{{__("Sửa thông tin hóa đơn")}}</h4>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$invoice->name}}" name="name" placeholder="Nhập tên hóa đơn">
                ...
                <div class="form-group">
                    ...
                    <select name="invoice_type_id" class="form-control js-select-search">
                        ...
                        @foreach ($invoiceTypes as $invoiceType)
                            <option  value="{{$invoiceType->id}}" {{$invoice->invoice_type_name==$invoiceType->name?'selected':''}}>{{$invoiceType->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="{{$invoice->amount}}" name="amount" placeholder="Nhập số tiền">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker" value="{{$invoice->date}}" name="date">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" class="form-control" value="{{$invoice->description}}" name="description" placeholder="Nhập nội dung"></textarea>
